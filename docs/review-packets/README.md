...
| [P0-06](P0-06-MONTAGE-ANSCHLUSS-BETRIEBSARTEN-SN045.md) | ab SN-045  | Montage, Pinbelegung, Versorgung, Ausgänge und Haftungsaussagen  | 11 P0 + 4 P1 als Gegenbelege | **in Vorbereitung**   |
| [P0-07](P0-07-BETRIEBSARTEN-GEOFENCING-SN045.md)        | ab SN-045  | Betriebsarten, Pin-3-Schaltschwellen, Geofencing, GPS-Diagnose   |   9 P0 + 1 P1 als Gegenbeleg | **in Vorbereitung**   |
| [P0-08](P0-08-SIM-AKTIVIERUNG-SN045.md)                 | ab SN-045  | SIM-Karte, Inbetriebnahme und anrufgesteuerte Funktionen         |  6 P0 + 2 P1 als Gegenbelege | **in Vorbereitung**   |
...
nicht übernommen. Umgekehrt gilt dasselbe: P0-06 bis P0-08 führen Werte bis SN-044 nur
als Gegenquelle.

**P0-06 bis P0-08 sind noch nicht zum Fachreview freigegeben.** Sie existieren, damit
...
erst nach der unabhängigen Gegenprüfung der Seiten 5–14 auf „bereit für Fachreview".
Zusammen decken sie die 26 sicherheitskritischen Segmente der Generation ab SN-045 mit
49 Einzelentscheidungen ab.
