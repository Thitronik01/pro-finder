...
| [P0-07](P0-07-ZIELRUFNUMMERN-SN045.md)             | ab SN-045  | Zielrufnummern, Programmiernachricht und Speicherlöschung        |   7 P0 + 1 P1 als Gegenbeleg | bereit für Fachreview |
...
| [P0-09](P0-09-BETRIEBSARTEN-GPS-LED-SN045.md)      | ab SN-045  | Betriebsarten, GPS-Diagnose und Status-LED                       |  10 P0 + 1 P1 als Gegenbeleg | bereit für Fachreview |
| [P0-10](P0-10-MELDUNGEN-ALARME-SN045.md)           | ab SN-045  | Meldungen, Alarme und Spannungswarnung                           |  11 P0 + 1 P1 als Gegenbeleg | bereit für Fachreview |
| [P0-11](P0-11-GEOFENCING-POSITION-SN045.md)        | ab SN-045  | Geofencing, Statusbericht und Positionsbewertung                 |  11 P0 + 1 P1 als Gegenbeleg | bereit für Fachreview |
| [P0-12](P0-12-AUSGAENGE-TECHNISCHE-DATEN-SN045.md) | ab SN-045  | Ausgangssteuerung und technische Daten                           |   7 P0 + 1 P1 als Gegenbeleg | bereit für Fachreview |
...
P0-06 bis P0-12 decken die Generation ab SN-045 vollständig ab: alle 63 sicherheitskritischen
Segmente des deutschen Teils sind genau einem Dossier zugeordnet. Ihre Segmente entstanden nicht in einer Selbstdurchsicht, sondern im Gegenlesen gegen die englische Fassung derselben Auflage; die belegte Seitenpaarung steht in
