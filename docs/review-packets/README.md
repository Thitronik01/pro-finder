...
| [P0-06](P0-06-MONTAGE-ANSCHLUSS-BETRIEBSARTEN-SN045.md) | ab SN-045  | Montage, Pinbelegung, Pin-3-Doppelbelegung und Haftungsaussagen  | 10 P0 + 3 P1 als Gegenbelege | **in Vorbereitung**   |
...
nicht übernommen. Umgekehrt gilt dasselbe: P0-06 führt Werte bis SN-044 nur als
Gegenquelle.

**P0-06 ist noch nicht zum Fachreview freigegeben.** Es existiert, damit kein
sicherheitskritisches Segment ohne Entscheidungszuordnung bleibt, bündelt aber
Erstextraktionen, deren PDF-Seiten auf `extracted` statt `validated` stehen. Es wechselt
erst nach der unabhängigen Gegenprüfung der Seiten 5–9 auf „bereit für Fachreview".
